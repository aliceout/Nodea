            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span className="ml-1.5 inline-flex h-5 shrink-0 items-center rounded bg-bg-2 px-1.5 text-[10px] font-semibold tracking-[0.04em] text-muted">
                    {PROVIDER_LABEL[book.source]}
                  </span>
                </button>
              </li>
            );
