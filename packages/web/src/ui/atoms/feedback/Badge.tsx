...
const toneStyles: Record<BadgeTone, string> = {
  neutral: 'border border-transparent bg-[rgba(148,163,184,0.14)] text-[#475569]',
  ...
  warning: 'border border-transparent bg-[rgba(250,204,21,0.14)] text-[#92400e]',
  danger: 'border border-transparent bg-[rgba(248,113,113,0.12)] text-[#b91c1c]',
};
