...
/**
 * K · Sauge select — same height (`h-8`) and rounding (`rounded-sm`)
 * as the dirk Input so the two align in inline rows (e.g. the
 * lookup bar's language picker next to the search input, or the
 * Status / Format / Tags row on a book form).
 *
  ...
  return (
    <select
      ...
      className={cn(
        ...
        'block h-8 w-full shrink-0 cursor-pointer rounded-sm border border-hair bg-bg px-2 text-[12.5px] text-ink',
