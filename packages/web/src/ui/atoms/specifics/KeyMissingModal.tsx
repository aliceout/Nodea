...
/**
 * Blocking modal shown when the in-memory main key is missing (page
 * reload with a valid session cookie but no password to re-derive it).
 * The only way out is to log out and log back in.
 */
