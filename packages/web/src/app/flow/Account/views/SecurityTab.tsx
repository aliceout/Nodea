 ...
 *  pages for password rotation, passkey management, TOTP enrol,
 *  recovery code, and security mode picker. Stateless on its own ;
 *  each link target owns its own flow. */
