...
import { MODULE_COLLECTIONS } from '@/core/modules/wipe-module';
import {
  useNodeaStore,
  selectMainKey,
  selectModules,
 ...
 *
 * The destructive `WipePanel` and the `ModuleToggle` switch live in
 * their own files (REFACTO-08) — top-level components so their identity
 * stays stable across this parent's re-renders (declaring them inline
 * used to remount them and drop the wipe's typed password mid-flight,
 * audit 2026-06).
 *
