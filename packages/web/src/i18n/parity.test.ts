...
import frCycle from '@/i18n/locales/fr/cycle.json';
import enCycle from '@/i18n/locales/en/cycle.json';

/**
 * The 17 namespaces under `i18n/locales/{fr,en}/`. Listed
...
const NAMESPACES: ReadonlyArray<readonly [string, Bag, Bag]> = [
  ...
  ['cycle', frCycle as Bag, enCycle as Bag],
];
