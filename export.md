  ...
  return (
    <Layout>
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-nodea-sand text-white py-3 rounded hover:bg-nodea-sand font-semibold"
        >
          Se connecter
        </button>
      </form>
...
File is too large to process (1177631 bytes)
...
module.exports = {
  content: [
    "./src/**/*.{js,jsx,ts,tsx}", // adapte selon ton arborescence
    "./public/index.html",
  ],
  theme: {
    extend: {
      colors: {
        "nodea-sage": "#90B6A2", // Principal, highlights, logo, boutons
        "nodea-sand": "#F7F4EF", // Fond principal, background, cartes
        "nodea-lavender": "#D8C7E4", // Accent, secondary bg, notifications
        "nodea-blush": "#F4D8D9", // Accent, alertes, tags, hover
        "nodea-sky": "#A9D6E5", // Liens, hover, graphes
        "nodea-slate": "#2B2D2F", // Texte principal, titres
      },
      fontFamily: {
        sans: ["Inter", "Roboto", "ui-sans-serif", "system-ui"],
        display: ["Poppins", "Nunito Sans", "ui-sans-serif", "system-ui"],
      },
    },
  },
  plugins: [],
